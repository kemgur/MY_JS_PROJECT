...
//I can use variable to use the function
var sumResult = function(a){
    return a+100;
}
console.log(sumResult(10));//110

//ARROW FUNCTION
//Remove function keyword and use=> symbol between input and body
var arrow=(a)=>{
    return a+100;
}
...
//3. Optional: We can remove paranthesis is around the parameter 
//IF THERE IS SINGLE
var arrow = a => a+100;
...
//2.OPTIMAL We can delete curly braces and return keyword
var arrow1 =(a,b) => a+b+100;
console.log(arrow1(6,7));//113

//ARROW FUNCTION CASE 3
//Traditional function(Geleneksel işlev) with no parameter
var x=10, y=20;
function sum2(){
return x+y+200;
}
