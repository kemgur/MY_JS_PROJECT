...
Javascript'te Sayıları Yuvarlama
Math.ceil(number)           —>Rounds Up(Yukari yuvarlama)
...
var fixedNumber = num.toFixed(2);//Parantez icindeki deger kadar basamak yazilir.
//virgunden sonra.
console.log(fixedNumber);//15.46
//it will get 2 digit after decimal point. like 15.46
