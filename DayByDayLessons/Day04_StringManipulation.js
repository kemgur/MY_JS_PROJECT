...
console.log(`Hello, ${firstLetter}${restOfWord}`);
 /*
1. Get one side of the square from the user and 
   print the area of the square on the console*/
...
/*
2. Get both sides of the rectangle form the user and
    print the perimeter of the rectangle on the console*/
...
/*
3. Get the radius of the circle from user and 
   print the area of the circle on the console */
...
//Cevabımı en yakın tam sayıya yuvarlamak
console.log(Math.round(areaOfCircle));//when radius = 5 anwer = 79

/*
4. Get both sides of the triangle and 
   print the hypothenuse of the triangle. 
...
5.Create a prompt : “Write your tweet” —-> use prompt.
   Type random text and calculate the number of sent character and 
   the remaining character.Note  Max character is 280.*/
